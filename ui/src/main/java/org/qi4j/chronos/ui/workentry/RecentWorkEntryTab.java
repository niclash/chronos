...
public abstract class RecentWorkEntryTab extends BaseTab
{
    public RecentWorkEntryTab( String title )
    {
        super( title );
    }
        ...
        return new BorderPanelWrapper( panelId )
        {
            public Panel getWrappedPanel( String panelId )
            {
                WorkEntryTable table = new WorkEntryTable( panelId )
                {
                    ...
                    {
                        return RecentWorkEntryTab.this.dataList( first, count );
                    }

                    public int getSize()
                    {
                        return RecentWorkEntryTab.this.getSize();
                    }
                };
