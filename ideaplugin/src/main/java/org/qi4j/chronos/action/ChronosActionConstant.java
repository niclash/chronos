...
public final class ChronosActionConstant
{
    ...
    public final static String WORKENTRY_LIST_GROUP = "ChronosWorkEntryListGroup";
    ...
    public final static String WORKENTRY_EDIT_ACTION = "ChronosWorkEntryEditAction";
    public final static String WORKENTRY_DELETE_ACTION = "ChronosWorkEntryDeleteAction";
    public final static String WORKENTRY_VIEW_DETAIL_ACTION = "ChronosWorkEntryViewDetailAction";
    public final static String WORKENTRY_NEW_COMMENT_ACTION = "ChronosWorkEntryNewCommentAction";
